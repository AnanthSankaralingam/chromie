...
Focus on getting production ready extensions to the store. we can't directly deploy to store but we can solve the problems there. lowkey ready to soft launch, but code quality can keep improving.
