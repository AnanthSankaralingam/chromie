...
/** Max chars logged for `[extension/codegen/follow-up] raw stream output` (avoid huge terminal spam). */
...
export async function POST(request) {
  try {
    ...
    console.error("Error in extension codegen follow-up API:", error)
    return extensionJson(
      request,
