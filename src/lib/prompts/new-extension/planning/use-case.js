...
<chrome_api_examples>
Common APIs: "storage", "tabs", "bookmarks", "notifications", "identity", "scripting", "alarms", "contextMenus", "history", "webRequest", "cookies", "windows", "action", "tabGroups", "downloads", "runtime", "identity", "tabCapture", "offscreen", "commands"
</chrome_api_examples>
...
- For keyboard shortcuts or hotkeys (e.g., "shortcut to close tabs", "keyboard shortcut"), you MUST include "commands" in the required_chrome_apis list. chrome.commands requires a background script.
</special_instructions>
