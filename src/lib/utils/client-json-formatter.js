/**
 * Client-side JSON formatter utility
 * Provides formatting functionality for the frontend file viewer
 */
...
/**
 * Formats any JSON file content based on file type
 ...
 * @returns {boolean} - True if the file is a JSON file
 */
...
/**
 * Checks if a file is a manifest.json file
 * @param {string} filename - The filename to check
 * @returns {boolean} - True if the file is manifest.json
 */
