...
export default function StreamingChat({
  ...
  const { isAdminMode = false } = useBuilderChat()
  const chatState = useChatState(projectId, hasGeneratedCodeProp, isAdminMode)
  const {
    inputMessage,
    setInputMessage,
    messages,
  ...
  }, [isAdminMode, autoGeneratePrompt, isProjectReady, hasGeneratedCode, isGenerating])
