...
export default function ProjectFilesPanel({
  ...
  return (
    <div className="h-full bg-background border-r border-border/50 flex flex-col">
      <div className="p-3 sm:p-4 border-b border-border/50 bg-secondary/20 flex-shrink-0">
        <div className="flex items-center space-x-2 mb-2 sm:mb-3">
          <Layers className="h-4 w-4 sm:h-5 sm:w-5 text-primary" />
          <h3 className="text-base sm:text-lg font-bold text-foreground">Project Files</h3>
        </div>
        <p className="text-xs sm:text-sm text-muted-foreground mb-2 sm:mb-3">Chrome Extension Structure</p>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2 bg-secondary/20 border border-border/50 rounded-lg text-xs sm:text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 transition-all shadow-sm"
          />
        </div>
      </div>
