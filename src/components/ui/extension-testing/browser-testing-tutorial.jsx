      ...
      <div className="w-full max-w-4xl mx-auto">
        <div className="relative">
          ...
          <div className="bg-card rounded-xl shadow-lg p-12">
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">Welcome to Extension Testing</h2>
            <p className="text-lg text-muted-foreground mb-12 text-center">Here's how to use the testing environment:</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <h3 className="text-xl font-semibold text-foreground">Interactive Testing</h3>
              ...
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <h3 className="text-xl font-semibold text-foreground">Keyboard Support</h3>
