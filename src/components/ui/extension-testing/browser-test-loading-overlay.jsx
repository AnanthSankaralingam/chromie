  ...
  return (
    <div className="absolute inset-0 bg-[#0a0a0a] flex justify-center items-start overflow-y-auto px-6 pt-5 pb-12 sm:px-10 sm:pt-6">
      <div className="w-full max-w-2xl">
        ...
        {tip && Icon && (
          <div className="rounded-2xl border border-white/15 bg-neutral-900/90 shadow-xl shadow-black/50 ring-1 ring-white/5 px-7 py-7 sm:px-10 sm:py-9 text-left">
            <ul className="list-none space-y-4 pl-0">
              {tip.items.map((item, index) => (
                <li key={index} className="flex gap-3 text-xl sm:text-2xl text-neutral-200 leading-relaxed">
                  <span
