      ...
      {FAQ_ITEMS.map((item) => {
        ...
        return (
          <div key={item.id} className="bg-black">
            ...
            >
              <span className="shrink-0 font-mono text-xs text-zinc-600">{item.num}</span>
            ...
            <AnimatedFaqPanel isOpen={isOpen}>
              <p className="border-t border-white/10 px-5 pb-5 pl-14 pr-6 text-sm leading-relaxed text-zinc-400 sm:px-6 sm:pb-6 sm:pl-[4.25rem]">
                {item.a}
              </p>
            </AnimatedFaqPanel>
          </div>
