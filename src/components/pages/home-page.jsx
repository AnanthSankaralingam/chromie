            ...
            >
              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-center gap-10 md:gap-16">
                  ...
                  <a href="https://bricked.ai/" target="_blank" rel="noopener noreferrer" className="opacity-75 hover:opacity-100 transition-opacity">
                    <img src="/bricked-logo.png" alt="Bricked" className="h-8 md:h-10 object-contain" style={{ mixBlendMode: "screen" }} />
                  </a>
                  <a href="https://mentrix.ai/" target="_blank" rel="noopener noreferrer" className="opacity-75 hover:opacity-100 transition-opacity">
                    <img src="/mentrix-logo.png" alt="Mentrix" className="h-8 md:h-10 object-contain" style={{ mixBlendMode: "screen" }} />
                  </a>
                  <a href="https://www.salesgraph.com/" target="_blank" rel="noopener noreferrer" className="opacity-75 hover:opacity-100 transition-opacity">
                    <img src="/salesgraph-logo.svg" alt="Salesgraph" className="h-8 md:h-10 w-auto max-w-[8.5rem] object-contain" style={{ mixBlendMode: "screen" }} />
                  </a>
                </div>
              </motion.div>
